...
export const ContactService = {
  getAll: (token: string,id:string) => apiService.get<Contact[]>(`/account/${id}/contacts`, token),

  getById: (account_id: string, token: string,contact_id:string) =>
    apiService.get<Contact>(`/account/${account_id}/contact/${contact_id}`, token),
  ...
  delete: (account_id: string, token: string,contact_id:string) =>
    apiService.delete<void>(`/account/${account_id}/contact/${contact_id}`, token),
};
